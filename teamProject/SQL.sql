...
CREATE TABLE PJT_SHOP_PRODUCT (
	...
	SHOP_NO CHAR(5 BYTE) NOT NULL REFERENCES PJT_SHOP_SHOP(SHOP_NO),
...
CREATE TABLE PJT_SHOP_PURCHASE(
    PURCHASE_NO CHAR(11 BYTE) NOT NULL PRIMARY KEY, 
...
CREATE TABLE PJT_SHOP_PURCHASE_DETAIL(
    PURCHASE_NO CHAR(11 BYTE) NOT NULL REFERENCES PJT_SHOP_PURCHASE(PURCHASE_NO), 
...
CREATE TABLE PJT_SHOP_SHOP(
	SHOP_NO CHAR(5 BYTE) NOT NULL PRIMARY KEY,
