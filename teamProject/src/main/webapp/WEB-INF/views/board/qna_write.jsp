							...
							<section class="border_detail">
								<article>
									<table style="width:90%">
										...
										<tr>
											<th>제목</th>
											<td colspan="3"><input type="text" name="t_b_title"></td>
										</tr>
										<tr>
											<th>글 내용</th>
											<td colspan="3"><textarea style="resize:none;width:100%;padding-bottom:300px;" name="t_b_content"></textarea></td>
										</tr>
										<tr>
											<th>작성자</th>
										...
										<tr>
											<td colspan="4">
												<input type="button" value="작성" onclick="location.href='qna_list.jsp'">
