					...
					<div id="main">
						<div class="inner">
							...
							<section class="border_detail">
								<article>
									<form name="fm">
									<input type="hidden" name="t_gubun" value="DBqna_update">
									...
									<table style="width:90%">
										...
										<tr>
											<th>글 내용</th>
											<td colspan="3"><textarea style="resize:none;width:100%;padding-bottom:300px;" name="t_content">${t_dto.getContent()}</textarea></td>
										</tr>
										<tr>
											<th>작성자</th>
											<td><input type="text" readonly value="${t_dto.getName()}"></td>
											<th>작성일</th>
