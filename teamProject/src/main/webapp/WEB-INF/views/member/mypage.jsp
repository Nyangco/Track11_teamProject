											...
											<table style="width:50%">
												...
												<tr>
													<th colspan="2" style="padding-top:0.75em;text-align:center;">
														<input type="button" value="회원 정보 변경" onclick="goWork('update','Member')" style="display:inline-block;">
														<input type="button" value="회원 탈퇴" onclick="goExit()" style="display:inline-block;">
														<input type="button" value="구매 이력" onclick="goWork('purchase_list','Member')" style="display:inline-block;">
													</th>
												</tr>
											</table>
										</fieldset>
