...
public class CommonUtil {
	...
	public static String getFile_dir_notice() {
		String noticeDir="C:/track_amh/work_project/web_homepage_jsl/WebContent/attach/notice/";	

		return noticeDir;
	}
	//뉴스 첨부 경로
	public static String getFile_dir_news() {
		String noticeDir="C:/track_amh/work_project/web_homepage_jsl/WebContent/attach/news/";	

		return noticeDir;
	}
	//자료실 첨부 경로
	public static String getFile_dir_pds() {
		String noticeDir="C:/track_amh/work_project/web_homepage_jsl/WebContent/attach/pds/";	
